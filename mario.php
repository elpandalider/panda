          ...
          <div class="panel-body">
            <div class="media">
              ...
              <div class="media-body">
                <iframe src='http://www.minijuegostop.com.mx/showFlash.php?id=17556' width='100%' height='500px' frameborder=0></iframe>
              </div>
            </div>
          </div>
        </div>
        ...
        <div class=" col panel panel-default col-md-offset-3 col-md-6">
          <div class="panel-body">
            ...
            <div id ="cal" class="ec-stars-wrapper col-md-offset-4 col-md-4">
              <?php $id = 1;
              for($x=1; $x<=($cal); $x++){
    	        echo "<a href='#cal' id='" . $id . "' class='select' data-value=" . $x ." title='Votar con " . $x ." estrellas'>&#9733;</a>";
              $id = $id +1; }
              for($x=1; $x<=(5-$cal); $x++){
