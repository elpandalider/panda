    ...
    <div class="container">
      <div class="text-center col-md-10 col-md-offset-1 titulo">
        <div class="page-header  animatedParent">
          <h2 class="animated fadeInUpShort">Cómo explicarle al niño/a que tiene TDA-H</h2>
      </div>
      </div>
      <div class="row">
        <div class="col-md-10 col-md-offset-1">
          ...
          <div class="animatedParent">
            <p class="intro animated fadeInUpShort">
              Las familias con hijos con TDAH solicitan orientación psicológica sobre cómo explicar el trastorno por déficit de atención e hiperactividad a sus hijos, especialmente la preocupación de los posibles beneficios
            ...
            <img class="centro animated fadeInUpShort" src="images\Consejos\14.jpg"><br>
          </div>


          <div class="animatedParent">
          <h4 align="center" class=" animated fadeInUpShort">   El foco principal es el ESTIGMA. </h4>
          <p class="intro cons animated fadeInUpShort">
