        ...
        <div class="col-md-offset-2 col-md-8">
          <div class="panel panel-primary panel-juego">
            <div class="panel-heading titulo-juego">
              <h1 class="panel-title text-center ">Juego Mental</h1>
            </div>
            <div class="panel-body videos">

                  <iframe  width="100%" height="100%" src="https://www.youtube.com/embed/ipsAl9LKa7Y" frameborder="0" allowfullscreen></iframe>
