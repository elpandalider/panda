    ...
    <div class="container-fluid">
      ...
      <div class="animatedParent">
          ...
          <p class="intro">
            ...
            Los investigadores que han estudiado la influencia de los genes en el TDAH afirman que es hereditario.
             Si su hijo biológico tiene TDAH hay una probabilidad de uno en cuatro (25%) de que usted también tenga este trastorno,
             ya sea que haya sido diagnosticado o no.<br><br>
            Según los estudios, los familiares de las personas con TDAH tienen cinco veces más probabilidades de presentar el
            trastorno, que las personas sin antecedentes familiares.<br><br>
            Además, se ha señalado en otros estudios, que la frecuencia del TDAH es mayor en los familiares biológicos de
            aquellos que padecen el trastorno, que en los familiares adoptivos.</p>
            <h4> Genetica molecular </h4>
          <p class="intro">
            Pese a que la investigación en genética molecular y TDAH esté todavía poco desarrollada,
            los estudios realizados han revelado que existe asociación entre algunos genes candidatos y el TDAH.
            <br><br>
            <strong>El TDAH se asocia con marcadores</strong> en los cromosomas 4, 5, 6, 8, 11, 16 y 17.2
            <br><br>
      ...
      <div class="animatedParent">
		...
		<div class="card card-block animated fadeInUpShort" style="padding: 30px;">
          ...
          <p class="intro">
            Para que podamos mantenernos enfocados y controlar nuestros impulsos, nuestro cerebro usa varias sustancias químicas importantes del
            cerebro. Los científicos las denominan “neurotransmisores” e incluyen la norepinefrina y la dopamina. Estas sustancias viajan a
          ...
          Se han asociado una serie de factores ambientales como factores de riesgo de padecer el Trastorno por Déficit de Atención e Hiperactividad,
          principalmente, durante el embarazo, el parto, y después del parto.</p>
          <h4> Se consideran factores ambientales </h4>
          <p class="intro"><strong> Principalmente:</strong> nacimiento prematuro, encefalopatía hipóxico-isquémica (síndrome que se manifiesta en la primera semana de vida producido por
          la disminución del aporte de oxígeno (O2) o la reducción mantenida del flujo sanguíneo cerebral), bajo peso al nacimiento y consumo de tabaco y alcohol durante el embarazo.
          </p>
      ...
      <div class="animatedParent">
          ...
          <p class="intro">
            ...
            aunque sí desempeñan un papel importante en el trastorno y  sobre todo, suponen una oportunidad para la intervención. <br><br>
            Así, algunos investigadores se han centrado en la familia, sobre todo en los factores contextuales (estrés, desavenencias matrimoniales
             o trastornos psicopatológicos de los padres) y la interacción entre padres e hijos. <br><br>
            El TDAH no es causado por falta de disciplina o cuidado. Es una condición biológica basada en el cerebro. Usted puede ser la influencia
