         ...
         <p class="intro">
          ...
          <div class="row">
            <div class="col-md-8">
              <div class="media-body">
                ...
                <p class="intro cons">
                  Es <strong> fundamental </strong> para el diagnóstico de TDAH evaluar que estos síntomas nucleares que hemos comentado
                  ...
                  <ul class="intro2">
                    ...
                    <li>Que tederioren o interfieran de forma significativa en el rendimiento del niño en dos o más de los ámbitos de su
                    vida: escolar o laboral, familiar y social</li>
          ...
          <div class="row">
            ...
            <div class="col-md-9"><br>
              ...
              <br>
              <ul>
                <li>Pereza ni falta de motivación </li><br>
                <li>Mala conducta intencionada </li><br>
                <li>Ausencia total de capacidad para fijar y mantener la atención </li><br>
                <li>No es un retraso mental ni falta de inteligencia</li>
              </ul>
            </div>
          </div>
