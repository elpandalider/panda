          ...
          <img class="media-object" src="images/ali/1.jpg" alt="Generic placeholder image">
            ...
            <div class="media-body">
              ...
              <p class="intro">Un aspecto relevante en la nutrición de los niños es que tengan siempre un nivel de glucosa estable durante el estudio,
                    dado que niveles de glucosa bajos afectan directamente al aprendizaje y al rendimiento cognitivo.Existen muchos alimentos
                    que pueden mantener la glucemia estable en nuestro cerebro y por lo tanto unas condiciones óptimas para el aprendizaje,
            ...
            <img class="media-object" src="images/ali/2.jpg" alt="Generic placeholder image">
              ...
              <div class="media-body">
                <h4 class="media-body"> Ácido aspártico </h4>
              ...
              <div class="media-body">
              <h4 class="media-body"> 	Colina </h4>
              <p class="intro">Sustancia clave para producir acetilcolina, un neurotransmisor vital en la transmisión de impulsos nerviosos a
              ...
              <div class="media-body">
              <h4 class="media-body"> Ácido glutámico	 </h4>
              <p class="intro">Es usado en la producción de glutamato, otro neurotransmisor. Se cree está involucrado en funciones cognitivas tales
              ...
              <div class="media-body">
              <h4 class="media-body"> Fenilalanina </h4>
              <p class="intro">Utilizada para la creación de dopamina, un neurotransmisor con numerosas funciones, entre ellas algunas relacionadas con el control de los movimientos y los estados de vigilia.
              ...
              <div class="media-body">
              <h4 class="media-body"> Triptófano </h4>
              <p class="intro">El cerebro lo utiliza para producir serotonina un neurotransmisor que desempeña un papel importante en la
                regulación de los estados anímicos, el sueño y el apetito, entre otras funciones como la atención y en la memoria.
              ...
              <div class="media-body">
              <h4 class="media-body"> Tirosina </h4>
              <p class="intro">Se utiliza en la producción de noradrenalina, también conocida como norepinefrina, un neurotransmisor involucrado en las funciones relacionadas
              ...
              <div class="media-body">
              <h4 class="media-body"> Proteínas </h4>
              <p class="intro">Las proteínas contenidas en alimentos de origen animal, especialmente en el hígado y los mariscos, contribuyen a la regulación de la capacidad intelectual y
                del estado de ánimo. Los <strong> ácidos grasos omega 3 </strong> tienen especial importancia en la nutrición cerebral por ser componentes importantes de las membranas celulares y en la vaina de mielina:
                contribuye a una mejora en el desarrollo cerebral y en las funciones cognitivas. Se encuentran principalmente en los<strong> peces de aguas frías y dulces (salmón, caballa, atún, arenque)</strong> y en la <strong>soja,
              ...
              <div class="media-body">
              <h4 class="media-body"> Hierro</h4>
              <p class="intro">El hierro influye en el rendimiento, en el transporte de oxígeno a las células y mantenimiento óptimo de cerebro. La falta de hierro influye negativamente en el desarrollo de este órgano y en el rendimiento cognitivo.
              ...
              <div class="media-body">
              <h4 class="media-body"> Zinc </h4>
              <p class="intro">El zinc parece estar relacionado con la actividad de los neurotransmisores:
